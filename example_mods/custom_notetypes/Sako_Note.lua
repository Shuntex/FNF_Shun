function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		--Check if the note is an Sako_Note
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Sako_Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'Sako_Notes'); --Change texture
