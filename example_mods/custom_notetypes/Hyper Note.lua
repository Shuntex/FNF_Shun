function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		--Check if the note is an Hyper Note
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Hyper Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'HyperNotes'); --Change texture
			setPropertyFromGroup('unspawnNotes', i, 'hitHealth', '-0.10'); --Default value is: 0.023, health gained on hit
			setPropertyFromGroup('unspawnNotes', i, 'missHealth', '0.40'); --Default value is: 0.0475, health lost on miss
