...
function onBeatHit()
	hurt = hurt + 0.0001
	cameraShake("HUD", shake, shakeTime);
	cameraShake("other", shake, shakeTime);
	...
	if getProperty('curBeat') > 295 then
		
		for i = 0, 7, 1 do
			noteTweenAngle('tween'.. i, i, 360, 0.2, 'linear');
		end
		
		
	end
	if getProperty('curBeat') > 296 then
	
		shake = 0.01
		shakeTime = 0.08
		
	end
	if getProperty('curBeat') > 297 then
	...
	if getProperty('curBeat') > 298 then
	
		shake = 0.01
		shakeTime = 0.08
		
	end
	if getProperty('curBeat') > 299 then
	...
	if getProperty('curBeat') > 311 then
	...
	if getProperty('curBeat') > 312 then
	
		shake = 0.01
		shakeTime = 0.08
		
	end
	if getProperty('curBeat') > 313 then
	...
	if getProperty('curBeat') > 314 then
	
		shake = 0.01
		shakeTime = 0.08
		
	end
	if getProperty('curBeat') > 315 then
	...
	if getProperty('curBeat') > 316 then
	...
	if getProperty('curBeat') > 349 then
